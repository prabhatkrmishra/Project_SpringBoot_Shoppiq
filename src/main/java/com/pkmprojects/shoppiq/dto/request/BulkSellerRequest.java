...
/**
 * Request DTO used for bulk creation of {@link com.pkmprojects.shoppiq.entity.Seller sellers}
 * by an admin user for test-data population.
 *
 * <p>
 * Wraps a list of {@link AdminSellerItem} to enable proper Bean Validation
 * on collection contents.
 * </p>
 *
 * <h2>Responsibilities</h2>
 * <ul>
 *     <li>Accept admin-supplied seller registration information in bulk.</li>
 ...
 *     <li>{@code @NotEmpty} ensures the client supplies at least one seller.</li>
 *     <li>{@code @Valid} triggers cascading validation on each
 *     {@link AdminSellerItem} in the list.</li>

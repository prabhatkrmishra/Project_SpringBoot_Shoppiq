...
/**
 * Business contract for managing user email notification preferences.
 *
 * <p>Defines operations for retrieving preferences (with auto-creation of defaults)
 * and partial updates of notification flags.</p>
 *

...
/**
 * Persistence operations for the {@link PromoCodeUsage} aggregate.
 *
 * <p>Provides methods to check promo code usage by order and count usage by user for promo code
 * enforcement. The repository supports existence checks for duplicate usage prevention and
 * count queries for user usage limit validation.</p>
 *
